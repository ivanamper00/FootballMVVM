...
public class LiveFragment extends Fragment {
    ...
    public LiveGamesAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        liveViewModel.getLive().observe(getViewLifecycleOwner(), result ->{
            Log.d("asdasdasdasd", result.get(0).getEmbed());
            displayData(result);
        });
    ...
    public void displayData(List<LiveScoreModel> lives){
        adapter = new LiveGamesAdapter(getContext(),lives);
